  ...
  const DataProcessor = {
    ...
    processStatistics(stats) {
      ...
      if (processed.totalMatches > 0) {
        ...
        // Goals per match
        processed.goalsForPerMatch = Number(((stats.goalsFor || 0) / processed.totalMatches).toFixed(2));
        processed.goalsAgainstPerMatch = Number(((stats.goalsAgainst || 0) / processed.totalMatches).toFixed(2));
        processed.goalDifferencePerMatch = Number((processed.goalsForPerMatch - processed.goalsAgainstPerMatch).toFixed(2));
      }
