...
(function(global) {
    ...
    class GoalsStatistics {
        ...
        calculateHalfGoals(matches, half) {
            return matches.reduce((total, match) => {
                if (half === 'first') {
                    return total + (parseInt(match.halfTimeHomeGoals || 0) + parseInt(match.halfTimeAwayGoals || 0));
                } else {
        ...
        calculateBTTS(matches) {
            ...
            return {
                ...
                no: {
                    ...
                    percentage: this.baseStats.percentage(matches.length - bttsMatches.length, matches.length)
                }
            };
        }
        ...
        calculateScoringPatterns(matches, teamId) {
            ...
            matches.forEach(match => {
                ...
                if (goalsFor > 0) {
                    ...
                    patterns.highestScorelessStreak = Math.max(patterns.highestScorelessStreak, currentScorelessStreak);
                }
        ...
        calculateScoringRate(matches, teamId) {
            ...
            return {
                ...
                avgGoalsWhenScoring: scoringMatches > 0 
