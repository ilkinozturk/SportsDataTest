...
class TeamDataService {
  ...
  processStatisticsLegacy(stats, additionalInfo = {}, matches = [], teamId = null) {
    ...
    return {
      ...
      cleanSheetsPercentage_overall: stats.seasonCSPercentage_overall || 0,
      cleanSheetsPercentage_home: stats.seasonCSPercentage_home || 0,
      cleanSheetsPercentage_away: stats.seasonCSPercentage_away || 0,
      ...
      // Clean sheet halftime percentages
      seasonCSPercentageHT_overall: stats.seasonCSPercentageHT_overall || additionalInfo.seasonCSPercentageHT_overall || 0,
      seasonCSPercentageHT_home: stats.seasonCSPercentageHT_home || additionalInfo.seasonCSPercentageHT_home || 0,
      seasonCSPercentageHT_away: stats.seasonCSPercentageHT_away || additionalInfo.seasonCSPercentageHT_away || 0,
      cs_2hg_percentage_overall: stats.cs_2hg_percentage_overall || additionalInfo.cs_2hg_percentage_overall || 0,
      cs_2hg_percentage_home: stats.cs_2hg_percentage_home || additionalInfo.cs_2hg_percentage_home || 0,
      cs_2hg_percentage_away: stats.cs_2hg_percentage_away || additionalInfo.cs_2hg_percentage_away || 0,
      
      // Conceded over percentages
      seasonConcededOver05Percentage_overall: stats.seasonConcededOver05Percentage_overall || additionalInfo.over05_conceded_percentage_overall || 0,
      seasonConcededOver15Percentage_overall: stats.seasonConcededOver15Percentage_overall || additionalInfo.over15_conceded_percentage_overall || 0,
      seasonConcededOver25Percentage_overall: stats.seasonConcededOver25Percentage_overall || additionalInfo.over25_conceded_percentage_overall || 0,
      seasonConcededOver05Percentage_home: stats.seasonConcededOver05Percentage_home || additionalInfo.over05_conceded_percentage_home || 0,
      seasonConcededOver15Percentage_home: stats.seasonConcededOver15Percentage_home || additionalInfo.over15_conceded_percentage_home || 0,
      seasonConcededOver25Percentage_home: stats.seasonConcededOver25Percentage_home || additionalInfo.over25_conceded_percentage_home || 0,
      seasonConcededOver05Percentage_away: stats.seasonConcededOver05Percentage_away || additionalInfo.over05_conceded_percentage_away || 0,
      seasonConcededOver15Percentage_away: stats.seasonConcededOver15Percentage_away || additionalInfo.over15_conceded_percentage_away || 0,
      seasonConcededOver25Percentage_away: stats.seasonConcededOver25Percentage_away || additionalInfo.over25_conceded_percentage_away || 0,
      
      // Highest conceded
      seasonHighestConceded_overall: stats.seasonHighestConceded_overall || additionalInfo.highest_conceded_overall || 0,
      seasonHighestConceded_home: stats.seasonHighestConceded_home || additionalInfo.highest_conceded_home || 0,
      seasonHighestConceded_away: stats.seasonHighestConceded_away || additionalInfo.highest_conceded_away || 0,
      ...
      cardsAVG: stats.cardsAVG_overall || 0,  // Add cardsAVG field for Match Cards display
      ...
      // Add _overall suffix versions for cards display
      cardsOver05_overall:
        stats.over05CardsPercentage_overall ||
        additionalInfo.over05_cards_percentage ||
        additionalInfo.over_05_cards_percentage ||
      ...
      // HT Results - Check both stats and additional_info for these fields
      // Also check for HT/FT result patterns in additional_info
      leadingAtHT_overall: stats.leadingAtHT_overall || 
        additionalInfo.leadingAtHT_overall ||
        additionalInfo.leading_at_ht_overall ||
        additionalInfo.ht_leading_overall ||
        (additionalInfo.ht_ft_WW || 0) + (additionalInfo.ht_ft_WD || 0) + (additionalInfo.ht_ft_WL || 0) ||
        0,
      leadingAtHT_home: stats.leadingAtHT_home || 
        additionalInfo.leadingAtHT_home ||
        additionalInfo.leading_at_ht_home ||
        additionalInfo.ht_leading_home ||
        0,
      leadingAtHT_away: stats.leadingAtHT_away || 
        additionalInfo.leadingAtHT_away ||
        additionalInfo.leading_at_ht_away ||
        additionalInfo.ht_leading_away ||
        0,
      leadingAtHTPercentage_overall: stats.leadingAtHTPercentage_overall || 
        additionalInfo.leadingAtHTPercentage_overall ||
        additionalInfo.leading_at_ht_percentage_overall ||
        additionalInfo.ht_leading_percentage_overall ||
        0,
      leadingAtHTPercentage_home: stats.leadingAtHTPercentage_home || 
        additionalInfo.leadingAtHTPercentage_home ||
        additionalInfo.leading_at_ht_percentage_home ||
        additionalInfo.ht_leading_percentage_home ||
        0,
      leadingAtHTPercentage_away: stats.leadingAtHTPercentage_away || 
        additionalInfo.leadingAtHTPercentage_away ||
        additionalInfo.leading_at_ht_percentage_away ||
        additionalInfo.ht_leading_percentage_away ||
        0,

      drawingAtHT_overall: stats.drawingAtHT_overall || 
        additionalInfo.drawingAtHT_overall ||
        additionalInfo.drawing_at_ht_overall ||
        additionalInfo.ht_drawing_overall ||
        (additionalInfo.ht_ft_DD || 0) + (additionalInfo.ht_ft_DW || 0) + (additionalInfo.ht_ft_DL || 0) ||
        0,
      drawingAtHT_home: stats.drawingAtHT_home || 
        additionalInfo.drawingAtHT_home ||
        additionalInfo.drawing_at_ht_home ||
        additionalInfo.ht_drawing_home ||
        0,
      drawingAtHT_away: stats.drawingAtHT_away || 
        additionalInfo.drawingAtHT_away ||
        additionalInfo.drawing_at_ht_away ||
        additionalInfo.ht_drawing_away ||
        0,
      drawingAtHTPercentage_overall: stats.drawingAtHTPercentage_overall || 
        additionalInfo.drawingAtHTPercentage_overall ||
        additionalInfo.drawing_at_ht_percentage_overall ||
        additionalInfo.ht_drawing_percentage_overall ||
        0,
      drawingAtHTPercentage_home: stats.drawingAtHTPercentage_home || 
        additionalInfo.drawingAtHTPercentage_home ||
        additionalInfo.drawing_at_ht_percentage_home ||
        additionalInfo.ht_drawing_percentage_home ||
        0,
      drawingAtHTPercentage_away: stats.drawingAtHTPercentage_away || 
        additionalInfo.drawingAtHTPercentage_away ||
        additionalInfo.drawing_at_ht_percentage_away ||
        additionalInfo.ht_drawing_percentage_away ||
        0,

      trailingAtHT_overall: stats.trailingAtHT_overall || 
        additionalInfo.trailingAtHT_overall ||
        additionalInfo.trailing_at_ht_overall ||
        additionalInfo.ht_trailing_overall ||
        additionalInfo.losingAtHT_overall ||
        additionalInfo.losing_at_ht_overall ||
        additionalInfo.ht_losing_overall ||
        (additionalInfo.ht_ft_LL || 0) + (additionalInfo.ht_ft_LW || 0) + (additionalInfo.ht_ft_LD || 0) ||
        0,
      trailingAtHT_home: stats.trailingAtHT_home || 
        additionalInfo.trailingAtHT_home ||
        additionalInfo.trailing_at_ht_home ||
        additionalInfo.ht_trailing_home ||
        additionalInfo.losingAtHT_home ||
        additionalInfo.losing_at_ht_home ||
        additionalInfo.ht_losing_home ||
        0,
      trailingAtHT_away: stats.trailingAtHT_away || 
        additionalInfo.trailingAtHT_away ||
        additionalInfo.trailing_at_ht_away ||
        additionalInfo.ht_trailing_away ||
        additionalInfo.losingAtHT_away ||
        additionalInfo.losing_at_ht_away ||
        additionalInfo.ht_losing_away ||
        0,
      trailingAtHTPercentage_overall: stats.trailingAtHTPercentage_overall || 
        additionalInfo.trailingAtHTPercentage_overall ||
        additionalInfo.trailing_at_ht_percentage_overall ||
        additionalInfo.ht_trailing_percentage_overall ||
        additionalInfo.losingAtHTPercentage_overall ||
        additionalInfo.losing_at_ht_percentage_overall ||
        additionalInfo.ht_losing_percentage_overall ||
        0,
      trailingAtHTPercentage_home: stats.trailingAtHTPercentage_home || 
        additionalInfo.trailingAtHTPercentage_home ||
        additionalInfo.trailing_at_ht_percentage_home ||
        additionalInfo.ht_trailing_percentage_home ||
        additionalInfo.losingAtHTPercentage_home ||
        additionalInfo.losing_at_ht_percentage_home ||
        additionalInfo.ht_losing_percentage_home ||
        0,
      trailingAtHTPercentage_away: stats.trailingAtHTPercentage_away || 
        additionalInfo.trailingAtHTPercentage_away ||
        additionalInfo.trailing_at_ht_percentage_away ||
        additionalInfo.ht_trailing_percentage_away ||
        additionalInfo.losingAtHTPercentage_away ||
        additionalInfo.losing_at_ht_percentage_away ||
        additionalInfo.ht_losing_percentage_away ||
        0,
      ...
      // Additional conceded fields for goals-display.js
      concededAVGHT_overall: stats.concededAVGHT_overall || additionalInfo.concededAVGHT_overall || additionalInfo.conceded_1hg_avg_overall || 0,
      concededAVGHT_home: stats.concededAVGHT_home || additionalInfo.concededAVGHT_home || additionalInfo.conceded_1hg_avg_home || 0,
      concededAVGHT_away: stats.concededAVGHT_away || additionalInfo.concededAVGHT_away || additionalInfo.conceded_1hg_avg_away || 0,
      
      firstHalfGoalsAgainstAVG_overall: stats.firstHalfGoalsAgainstAVG_overall || additionalInfo.firstHalfGoalsAgainstAVG_overall || additionalInfo.conceded_1hg_avg_overall || 0,
      firstHalfGoalsAgainstAVG_home: stats.firstHalfGoalsAgainstAVG_home || additionalInfo.firstHalfGoalsAgainstAVG_home || additionalInfo.conceded_1hg_avg_home || 0,
      firstHalfGoalsAgainstAVG_away: stats.firstHalfGoalsAgainstAVG_away || additionalInfo.firstHalfGoalsAgainstAVG_away || additionalInfo.conceded_1hg_avg_away || 0,
      
      secondHalfGoalsAgainstAVG_overall: stats.secondHalfGoalsAgainstAVG_overall || additionalInfo.secondHalfGoalsAgainstAVG_overall || stats.conceded_2hg_avg_overall || additionalInfo.conceded_2hg_avg_overall || 0,
      secondHalfGoalsAgainstAVG_home: stats.secondHalfGoalsAgainstAVG_home || additionalInfo.secondHalfGoalsAgainstAVG_home || stats.conceded_2hg_avg_home || additionalInfo.conceded_2hg_avg_home || 0,
      secondHalfGoalsAgainstAVG_away: stats.secondHalfGoalsAgainstAVG_away || additionalInfo.secondHalfGoalsAgainstAVG_away || stats.conceded_2hg_avg_away || additionalInfo.conceded_2hg_avg_away || 0,
      
      concededAVG2H_overall: stats.concededAVG2H_overall || additionalInfo.concededAVG2H_overall || stats.conceded_2hg_avg_overall || additionalInfo.conceded_2hg_avg_overall || 0,
      concededAVG2H_home: stats.concededAVG2H_home || additionalInfo.concededAVG2H_home || stats.conceded_2hg_avg_home || additionalInfo.conceded_2hg_avg_home || 0,
      concededAVG2H_away: stats.concededAVG2H_away || additionalInfo.concededAVG2H_away || stats.conceded_2hg_avg_away || additionalInfo.conceded_2hg_avg_away || 0,
      
      // Minutes per conceded goal
      minutesPerConceded_overall: stats.minutesPerConceded_overall || additionalInfo.minutesPerConceded_overall || additionalInfo.minutes_per_conceded_overall || 0,
      minutesPerConceded_home: stats.minutesPerConceded_home || additionalInfo.minutesPerConceded_home || additionalInfo.minutes_per_conceded_home || 0,
      minutesPerConceded_away: stats.minutesPerConceded_away || additionalInfo.minutesPerConceded_away || additionalInfo.minutes_per_conceded_away || 0,
      
      // Over conceded percentages
      ...
      highestConceded_home: stats.highestConceded_home || additionalInfo.highestConceded_home || additionalInfo.highest_conceded_home || 0,
      highestConceded_away: stats.highestConceded_away || additionalInfo.highestConceded_away || additionalInfo.highest_conceded_away || 0,
      ...
      shotsPerMatch: Math.round((stats.shotsAVG_overall || additionalInfo.shotsAVG_overall || 0) * 100) / 100,
      shotsPerMatch_home: Math.round((stats.shotsAVG_home || additionalInfo.shotsAVG_home || 0) * 100) / 100,
      shotsPerMatch_away: Math.round((stats.shotsAVG_away || additionalInfo.shotsAVG_away || 0) * 100) / 100,
      ...
      shotsOnTargetPerMatch: Math.round((stats.shotsOnTargetAVG_overall || additionalInfo.shotsOnTargetAVG_overall || 0) * 100) / 100,
      shotsOnTargetPerMatch_home: Math.round((stats.shotsOnTargetAVG_home || additionalInfo.shotsOnTargetAVG_home || 0) * 100) / 100,
      shotsOnTargetPerMatch_away: Math.round((stats.shotsOnTargetAVG_away || additionalInfo.shotsOnTargetAVG_away || 0) * 100) / 100,
      ...
      // Add aliases for frontend
      shotsOffTargetPerMatch: Math.round((stats.shotsOffTargetAVG_overall || additionalInfo.shotsOffTargetAVG_overall || 0) * 100) / 100,
      shotsOffTargetPerMatch_home: Math.round((stats.shotsOffTargetAVG_home || additionalInfo.shotsOffTargetAVG_home || 0) * 100) / 100,
      shotsOffTargetPerMatch_away: Math.round((stats.shotsOffTargetAVG_away || additionalInfo.shotsOffTargetAVG_away || 0) * 100) / 100,
