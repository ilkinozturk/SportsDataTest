  ...
  class CardsData {
    ...
    processCardsData(stats, additionalInfo = {}) {
      return {
        ...
        cardsOver05:
          stats.over05CardsPercentage_overall || additionalInfo.over05_cards_percentage || 0,
        cardsOver15:
          stats.over15CardsPercentage_overall || additionalInfo.over15_cards_percentage || 0,
        cardsOver25:
          stats.over25CardsPercentage_overall || additionalInfo.over25_cards_percentage || 0,
        cardsOver35:
          stats.over35CardsPercentage_overall || additionalInfo.over35_cards_percentage || 0,
        cardsOver45:
          stats.over45CardsPercentage_overall || additionalInfo.over45_cards_percentage || 0,
        cardsOver55:
          stats.over55CardsPercentage_overall || additionalInfo.over55_cards_percentage || 0,
        ...
        cardsOver05_home:
          stats.over05CardsPercentage_home || additionalInfo.over05_cards_percentage_home || 0,
        cardsOver15_home:
          stats.over15CardsPercentage_home || additionalInfo.over15_cards_percentage_home || 0,
        cardsOver25_home:
          stats.over25CardsPercentage_home || additionalInfo.over25_cards_percentage_home || 0,
        cardsOver35_home:
          stats.over35CardsPercentage_home || additionalInfo.over35_cards_percentage_home || 0,
        cardsOver45_home:
          stats.over45CardsPercentage_home || additionalInfo.over45_cards_percentage_home || 0,
        cardsOver55_home:
          stats.over55CardsPercentage_home || additionalInfo.over55_cards_percentage_home || 0,

        // Cards Over percentages - Away
        cardsOver05_away:
          stats.over05CardsPercentage_away || additionalInfo.over05_cards_percentage_away || 0,
        cardsOver15_away:
          stats.over15CardsPercentage_away || additionalInfo.over15_cards_percentage_away || 0,
        cardsOver25_away:
          stats.over25CardsPercentage_away || additionalInfo.over25_cards_percentage_away || 0,
        cardsOver35_away:
          stats.over35CardsPercentage_away || additionalInfo.over35_cards_percentage_away || 0,
        cardsOver45_away:
          stats.over45CardsPercentage_away || additionalInfo.over45_cards_percentage_away || 0,
        cardsOver55_away:
          stats.over55CardsPercentage_away || additionalInfo.over55_cards_percentage_away || 0,
