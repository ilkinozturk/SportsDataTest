...
(function(global) {
  ...
  const Renderer = {
    ...
    setupDefaultTemplates() {
      ...
      this.registerTemplate('stat-item', `
        <div class="stat-item">
      ...
      this.registerTemplate('stat-card', `
        <div class="stat-card">
      ...
      this.registerTemplate('match-result', `
    ...
    renderAdvanced(template, data) {
      ...
      let processed = template.replace(/\{\{#if (\w+)\}\}(.*?)\{\{\/if\}\}/gs, (match, condition, content) => {
