...
(function(global) {
    ...
    class TabManager {
        ...
        getPerformanceMetrics() {
            const avgSwitchTime = this.performanceMetrics.totalSwitchTime / 
                                 (this.performanceMetrics.switchCount || 1);
            ...
            return {
                ...
                tabAverages,
                fastestTab: Object.entries(tabAverages)
                    .sort(([,a], [,b]) => a - b)[0]?.[0],
                slowestTab: Object.entries(tabAverages)
                    .sort(([,a], [,b]) => b - a)[0]?.[0]
            };
        }
